...
const Banner = () => {
  ...
  <div className=" flex items-center space-x-28 bg-base-200 min-h-[70vh] px-6">
    ...
    <div className='text-start w-[700px]'>
      ...
      to Get Your New <motion.span animate={{color:["#bcbce1","#0c0c88"]}} transition={{duration:1.5, repeat:Infinity}}> Job</motion.span></motion.h1>
      <p className="py-6">
    ...
    <div className=''>
     <motion.img animate={{y:[50,100,50]} } transition={{duration:10,delay:1, ease:easeInOut, repeat:Infinity}}
      src={team1}
      className="max-w-sm rounded-bl-none rounded-[40px] shadow-2xl border-l-8 border-b-8 border-blue-700" />
